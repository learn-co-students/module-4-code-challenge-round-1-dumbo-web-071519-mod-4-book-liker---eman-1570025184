...
DONE -  Render a list of books that show the book title and book image in the Book List
DONE -  Clicking on a book in the Book List should add it to the Bookshelf
